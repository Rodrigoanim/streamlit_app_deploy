...
def authenticate_user():
    ...
    if not st.session_state["logged_in"]:
        ...
        # Login na sidebar - versão 3.3f
        st.sidebar.markdown("<h1 style='color: white; font-size: 24px;'>FCIAPC - ver. 3.3f</h1>", unsafe_allow_html=True)
